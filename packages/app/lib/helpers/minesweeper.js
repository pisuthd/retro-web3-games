...
const handleAction = (state, solution, position) => {
...
const addFlag = (state, solution, position) => {
...
const initBlankField = (width, height) => {
    return Array(width * height).fill(Cell.blank);
}

const revealBoardOnClick = (board, mineField, i, w) => {
    let newBoard = [...board];
...
const initMineField = (width, height, x, y, cnt) => {
...
exports.initMineField = initMineField
exports.initBlankField = initBlankField
exports.Cell = Cell
